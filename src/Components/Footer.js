  ...
  return (
    ...
    <div className='md:grid grid-col-7 grid-flow-col' >
        <div className='col-span-1' >
            ...
            <a href='https://form.jotform.com/240951205334449'> <button className="uppercase flex items-center justify-center gap-3 rounded-lg shadow-md  font-[NeueMedium] ease-in duration-300  text-[12px] md:text-[16px]  hover:shadow-none hover:bg-[#272727] tracking-wider py-[8px] px-[24px] mt-3 md:py-[12px] md:px-[24px] text-[#FFFEFC] bg-[#D64C27]" >Book Now  </button></a>
        </div>
